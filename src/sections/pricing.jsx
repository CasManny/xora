      ...
      <Element name="pricing">
        <div className="container">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            ...
            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blue-[6px] max-md:w-[310px]">
              <button
              ...
              <div className="pricing-bg">
                ...
                <img
                  ...
                  width={960}
                  height={380}
                  className="inset-0 absolute opacity-5 mix-blend-soft-light"
                />
              </div>
            </div>
          </div>
              ...
              >
                ...
                <ul className="mx-auto space-y-4 xl:px-7">
                  {plan.features.map((feature) => (
                    <li
                      key={feature}
                      className="relative flex text-left items-center gap-5"
                    >
                      <img
